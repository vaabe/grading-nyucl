...
- `-v` to show the student submissions selector. A list of students will be printed, with ungraded ones highlighted in yellow. Enter the student's number to open their submission attachments. Pdf files are opened with zathura, and docx files are opened with LibreOffice. 
