...
- Open the student selector by running `grade <dir> -g`. This will print a list of students, based on the list in the grades.csv file. It highlights in yellow the students who haven't been graded yet. 
