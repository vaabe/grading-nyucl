...
- `-g` to show the grading comments selector. A list of students will be printed, with ungraded ones highlighted in yellow ([Fig. 1](https://github.com/vaabe/grading/blob/main/media/student-selector.png)). Enter the student's number to open their comments.txt file for grading. Both the comments file and the commentsbuffer file are opened in Vim ([Fig. 2](https://github.com/vaabe/grading/blob/main/media/comments-txt.png)). 
